...
wk.add({
    {
        ...
        { "<leader>cd", "<cmd>lua vim.diagnostic.open_float()<cr>",                            desc = "Code: Show diagnostics" },
        { "<leader>ct", "<cmd>lua vim.diagnostic.enable(not vim.diagnostic.is_enabled())<cr>", desc = "Code: Toggle diagnostics" },
    },
})
