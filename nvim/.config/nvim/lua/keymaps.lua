...
-- tmux-navigator
wk.add({
    { "<c-h>", "<cmd><C-U>TmuxNavigateLeft<cr>", icon = "🔀", desc = "Navigate left" },
    { "<c-j>", "<cmd><C-U>TmuxNavigateDown<cr>", icon = "🔀", desc = "Navigate down" },
    { "<c-k>", "<cmd><C-U>TmuxNavigateUp<cr>", icon = "🔀", desc = "Navigate up" },
    { "<c-l>", "<cmd><C-U>TmuxNavigateRight<cr>", icon = "🔀", desc = "Navigate right" },
    { "<c-\\>", "<cmd><C-U>TmuxNavigatePrevious<cr>", icon = "🔀", desc = "Navigate previous" },
})
